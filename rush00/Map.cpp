...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/07/09 15:38:31 by ofedorov          #+#    #+#             */
/*   Updated: 2017/07/09 23:34:59 by vtenigin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	_score(0)
{
	...
	for (int h = 0; h < this->_height; h++)
		for (int w = 0; w < this->_width; w++)
			this->_map[h][w] = NULL;
	this->player = new Entity(width / 2, height / 10 * 9, 3, 0, Entity::PLAYER); //TODO change coordinates
